...
scale_colour_cesar_g <- function(name = waiver(), ..., mid = 0, alpha = 1, reverse = FALSE, palette = "green_brown_d", guide = "colourbar",
  ...
  if(!palette %in% c("green_brown_d", "teal_orange_d", "orange_green_d", "gold_teal_d", "red_blue_d", "colin_d")){
    stop('palette not in list of divergent palettes; use one of c("green_brown_d", "teal_orange_d", "orange_green_d", "gold_teal_d", "red_blue_d", "colin_d")')
  }
